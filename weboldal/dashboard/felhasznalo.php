...
<head>
    ...
    <title>Felhasználói felület | Cengiz Airlines Adatkezelő</title>
    ...
    <script src="../src/js/felhasznaloDB.js"></script>
...
<div id="felvetel-message" title="Adatfelvétel">
  <p>
    <span class="ui-icon ui-icon-circle-check" style="float:left; margin:0 7px 50px 0;"></span>
   Sikeresen hozzáadott felhasználót!
  </p>
</div>

<div id="felvetel-form" title="Új felhasználó felvétele">
  <form id="felvetelform">
<div class="field">
  <label class="label">Username</label>
  <div class="control">
    <input class="input" id="uj-username-form" type="text" required>
  </div>
</div>
...
<div class="field">
  ...
  <div class="control">
    <input class="input" id="uj-jelszo-form" type="text"  required>
  </div>
</div>
...
<div id="update-form" title="Módosítani a meglévő felhasználót">
  <form id="updateform">
<div class="field">
  <label class="label">Username</label>
  <div class="control">
    <input class="input" id="username-form" type="text" value="" disabled>
  </div>
</div>
...
<div class="field">
  <label class="label">Jelszó</label>
  <div class="control">
    <input class="input" id="jelszo-form" type="text" value="" required>
  </div>
</div>
...
<nav class="navbar container" role="navigation" aria-label="main navigation">
  ...
  <div class="container box">
    <h1 class="title">Felhasznalók</h1>
    <button class="button is-dark" style="margin-bottom: 20px" id="adatfelvetel">Felhasználó felvétel</button>
    <div class="control">
  <input class="input" type="text" id="kereses-real-time" placeholder="Keresés username alapján">
</div>
    <div class="b-table">
