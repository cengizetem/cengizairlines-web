...
<head>
    ...
    <title>Városok | Cengiz Airlines Adatkezelő</title>
    ...
    <script src="../src/js/varosokDB.js"></script>
...
<div id="felvetel-message" title="Adatfelvétel">
  <p>
   ...
   Sikeresen hozzáadott várost!
  </p>
</div>

<div id="felvetel-form" title="Új város felvétele">
  <form id="felvetelform">
  
<div class="field">
  <label class="label">ISO kód</label>
  <div class="control">
    <div class="select is-rounded" id="uj-ISO-form">
  <select id="uj-iso_select">
...
<div class="field">
  ...
  <div class="control">
    <input class="input" id="uj-varos-form" type="text" value="" required>
  </div>
</div>
...
<div id="update-form" title="Módosítani a meglévő várost">
  <form id="updateform">
<div class="field">
  <label class="label">#</label>
  <div class="control">
    <input class="input" id="id-form" type="text" value="" disabled>
  </div>
</div>
...
<div class="field">
  <label class="label">ISO kód</label>
  <div class="control">
    <div class="select is-rounded" id="ISO-form">
...
<div class="field">
  <label class="label">Város</label>
  <div class="control">
    <input class="input" id="varos-form" type="text" value="" required>
  </div>
</div>
...
<nav class="navbar container" role="navigation" aria-label="main navigation">
  ...
  <div class="container box">
    <h1 class="title">Városok</h1>
    <button class="button is-dark" style="margin-bottom: 20px" id="adatfelvetel">Város felvétel</button>
    <div class="control">
  <input class="input" type="text" id="kereses-real-time" placeholder="Keresés város alapján">
</div>
    <div class="b-table">
